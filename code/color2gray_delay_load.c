 ...
 */
FARPROC WINAPI color2grayDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = color2grayDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = color2grayDelayLoadWin32FailureHook;
#endif
