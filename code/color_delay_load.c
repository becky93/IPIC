 ...
 */
FARPROC WINAPI colorDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = colorDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = colorDelayLoadWin32FailureHook;
#endif
